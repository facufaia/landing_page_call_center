...
function LegalSecurity(){
    return(
        <main className="flex flex-col">
            ...
            <section className="mx-12 my-20 flex gap-7 flex-wrap lg:mx-20">
            ...
            <section className="flex flex-wrap lg:h-min bg-slate-50">
                ...
                <div className="flex flex-col justify-center gap-6 py-12 px-10 lg:pl-10 sm:pl-14 lg:w-6/12 lg:gap-12">
                    ...
                    <p className="text-base mb-3 text-gray-500 lg:text-2xl">
            ...
            <section className="bg-red-800 text-gray-200 px-10 text-center py-14 text-base lg:text-lg">
                ...
                <button className="bg-red-800 text-white w-max px-2 pb-1 text-lg hover:bg-white hover:text-red-800 duration-500 border mt-12 border-white min-[380px]:text-2xl lg:mt-16">
                    <a>Veamos tu caso</a>
                </button>
            </section>
            <ContactForm/>
