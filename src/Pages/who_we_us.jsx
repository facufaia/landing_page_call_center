...
function WhoWeUs(){
    ...
    return(
        <main className="flex flex-col">
            ...
            <section ref={elementRef} className={`mt-16 mx-20 mb-12 text-center text-sm text-gray-600 lg:mx-44 lg:text-2xl lg:py-14 opacity-0 ${isIntersecting ? "animate_animated animate_fadeIn" : ""}`}>
