    ...
    return(
        <section className="flex flex-col items-center text-center mx-10 tablet:mx-20 gap-2 my-14">
            ...
            <div className="text-lg flex flex-col tablet:flex-row text-gray-500 gap-4 text-center lg:flex-row lg:mx-40 lg:gap-32 lg:my-10">
                <p className="lg:w-1/2">Nuestro <b>equipo especializado</b> se encarga de <b>eliminar en forma definitiva todo registro de deudas de las bases de datos de informe de riesgo crediticio</b> haciendo valer las prerrogativas de la Ley de Protección de los Datos Personales (Ley Nº 25.326).<br/><br/>
                ...
                <div className="lg:w-1/2 flex flex-col items-center gap-7">
                    ...
                    <button className="bg-red-800 text-white w-max px-2 pb-1 text-lg hover:bg-white hover:text-red-800 duration-500 border border-red-800 min-[380px]:text-2xl lg:my-16"><a>Veamos tu caso</a></button>
                </div>
            </div>
